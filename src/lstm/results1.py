...
def main():
    ...
    history_path = project_root / "models" / "lstm" / "20251227_143405_lr1e-03_bs1024_u64_w36_h1" / "training_history.json"
    output_path = project_root / "reports" / "lstm_training_history.png"
